...
public class SettleUpListItemAdapter extends RecyclerView.Adapter<SettleUpListItemAdapter.ViewHolder> {

    private boolean showDeleteIcon = false;
    private OnDeleteListItemListener onDeleteSettleUpListener;
    private List<SettleUpListItem> itemList;

    public SettleUpListItemAdapter(List<SettleUpListItem> itemList, OnDeleteListItemListener onDeleteSettleUpListener) {
        this.itemList = itemList;
        this.onDeleteSettleUpListener = onDeleteSettleUpListener;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_settle_up, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int pos) {
        ...
        SettleUpListItem item = itemList.get(position);
    ...
    private void removeItem(int position) {
        onDeleteSettleUpListener.onDeleteClick(position, itemList.get(position).getId());
    }
